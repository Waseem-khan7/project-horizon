  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        onChange={onChange}
        className={`w-full rounded-xl border bg-slate-50 px-4 py-3 text-slate-700 transition-all duration-300 outline-none placeholder:text-slate-400 focus:bg-white focus:ring-4 ${
          error
